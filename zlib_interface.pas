...
// Core functions
function zlibVersion;          external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateInit_;         external {$IFDEF ZLIB_DLL}libz{$ENDIF}; // wrapped by deflateInit()
function deflate;              external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateEnd;           external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateInit_;         external {$IFDEF ZLIB_DLL}libz{$ENDIF}; // wrapped by inflateInit()
function inflate;              external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateEnd;           external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateInit2_;        external {$IFDEF ZLIB_DLL}libz{$ENDIF}; // wrapped by deflateInit2()
function deflateSetDictionary; external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateCopy;          external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateReset;         external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateParams;        external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflateBound;         external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function deflatePrime;         external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateInit2_;        external {$IFDEF ZLIB_DLL}libz{$ENDIF}; // wrapped by inflateInit2()
function inflateSetDictionary; external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateSync;          external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateCopy;          external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateReset;         external {$IFDEF ZLIB_DLL}libz{$ENDIF};

function inflateBackInit_;     external {$IFDEF ZLIB_DLL}libz{$ENDIF};

function inflateBack;          external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateBackEnd;       external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function zlibCompileFlags;     external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function compress;             external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function compress2;            external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function compressBound;        external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function uncompress;           external {$IFDEF ZLIB_DLL}libz{$ENDIF};

// Checksums
function adler32;              external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function crc32;                external {$IFDEF ZLIB_DLL}libz{$ENDIF};

function zError;               external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function inflateSyncPoint;     external {$IFDEF ZLIB_DLL}libz{$ENDIF};
function get_crc_table;        external {$IFDEF ZLIB_DLL}libz{$ENDIF};
